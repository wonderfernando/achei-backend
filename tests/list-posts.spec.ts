...
describe("list posts", () => {
    ...
    it("should  be possible get all posts by age id",async () => {
        ...
        postRepository.posts.push({id:"123", title:"", img:"",contact1:"",contact2:"",user_id:"123",description:"",city_id:"123",age_id:"1",status:"",gender:""})
        postRepository.posts.push({id:"123", title:"", img:"",contact1:"",contact2:"",user_id:"123",description:"",city_id:"123", age_id:"1",status:"",gender:""})
        postRepository.posts.push({id:"123", title:"", img:"",contact1:"",contact2:"",user_id:"123",description:"",city_id:"333", age_id:"121",status:"",gender:""})
